...
function DOMPop(event) {
    ...
    if (selectedText.length > 0) {
        // update: chrome v61 doesn't support document.body.scrollTop anymore
        var scollEle = document.scrollingElement ? document.scrollingElement : document.body
        var scrollX = scollEle.scrollLeft;
        var scrollY = scollEle.scrollTop;
